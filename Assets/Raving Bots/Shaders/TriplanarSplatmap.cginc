...
#ifdef _NORMALMAP
		mixedNormal  = UnpackNormalWithScale(Triplanar(worldPos, normal, _Splat0_ST, _Normal0), _NormalScale0) * splat_control.r;
		mixedNormal += UnpackNormalWithScale(Triplanar(worldPos, normal, _Splat1_ST, _Normal1), _NormalScale1) * splat_control.g;
		mixedNormal += UnpackNormalWithScale(Triplanar(worldPos, normal, _Splat2_ST, _Normal2), _NormalScale2) * splat_control.b;
		mixedNormal += UnpackNormalWithScale(Triplanar(worldPos, normal, _Splat3_ST, _Normal3), _NormalScale3) * splat_control.a;
